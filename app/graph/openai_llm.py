        ...
        *,
        ...
        result = self._json_response(
            (
                ...
                "Use this exact CTA even if another CTA appears in examples: "
                "'¿Tiene sentido que te comparta 2-3 hipótesis concretas?' "
                "Use '2-3 hipótesis' rather than generic 'ideas' when it sounds natural. "
                ...
                "exceptions into repeatable decisions, but do not list more than two "
                "operational nouns from this set in the same sentence: datos, reglas, "
                "excepciones, trazabilidad, revisión humana, integraciones, soporte, "
                "marketplace. Do not mention permissions unless the evidence explicitly "
                "supports permissions; for agentic_workflow_fit, focus "
                "on handoffs, actions, routing and workflow execution; for "
                "partner_or_adjacent_vendor, position NYVEX as complementary and "
                "exploratory, not as a competitor selling the same thing; for "
        ...
        *,
        ...
        result = self._json_response(
            (
                ...
                "when provided. Use this exact CTA: '¿Tiene sentido que te comparta "
                "2-3 hipótesis concretas?' For data_ops_fit, do not list more than "
                "two operational nouns from this set in the same sentence: datos, "
                "reglas, excepciones, trazabilidad, revisión humana, integraciones, "
                "soporte, marketplace. Do not mention permissions unless the evidence "
                "explicitly supports permissions. For partner_or_adjacent_vendor, "
                "position NYVEX as complementary and exploratory. "
                f"Keep body under {max_words} words."
            ),
            {
                "lead": lead.model_dump(mode="json"),
        ...
        *,
        ...
        result = self._json_response(
            (
                ...
                "Reject if a friction or NYVEX angle sentence becomes a kitchen-sink "
                "list of system concepts, especially if it stacks more than four of: "
                "datos, reglas, permisos, excepciones, trazabilidad, revisión humana, "
                "integraciones, soporte, marketplace, herramientas. The email should "
                "sound like one clear hypothesis, not an architecture inventory. "
                "Prefer the CTA '¿Tiene sentido que te comparta 2-3 hipótesis concretas?' "
                "over a generic 'ideas' CTA. "
